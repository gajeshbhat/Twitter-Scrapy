...
class Tweet(Item):
    ...
    hash_tag = Field() # To keep track of hashtags each tweet has an extra field
    city_country =  Field() # Keeps track on the country

    user_avatar = Field() # avator url
    user_screen_name = Field()
    user_profile_name = Field() # user name
